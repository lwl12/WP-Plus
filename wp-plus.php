...
<input type="submit" class="button-primary" value="保存设置" /> &nbsp WP-Plus 版本 1.2 &nbsp; 插件作者为 <a href="http://lwl12.com">liwanglin12</a> &nbsp; <a href="http://blog.lwl12.com/wp-plus">点击获取最新版本 & 说明
</form>
</div>
<?php
}
